...
#[derive(Debug)]
pub struct BlockIndexerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockIndexerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockIndexer processing");
    
    let mut processor = BlockIndexerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockIndexerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockIndexerProcessor::new(false);
